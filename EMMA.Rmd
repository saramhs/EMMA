...
dataFolder   <- file.path("/Users/safl/Reference_folder/EMMA/Directory/Data/") # Set path to the data and figure folder
figureFolder <- file.path("/Users/safl/Reference_folder/EMMA/Directory/Figures/")
RFolder      <- file.path("/Users/safl/Reference_folder/EMMA/Directory/RScripts/") # Set the path to the RScript folder
# Load the R libraries
pkgs<-c("dplyr","MASS","lubridate","plyr","reshape2","ggmap","ggplot2","scales","rgdal","tools")
l<-lapply(pkgs, require, character.only = TRUE) #MASS: #Modern Applied Statistics with S
```
